...
// define empty variable of type webSocketShutdownEvent

void (*webSocketShutdownCallback)(void) = NULL;


void get_on_websocket_want_to_close_obs(void (*webSocketWantToCloseObs)(void)) {
    webSocketShutdownCallback = webSocketWantToCloseObs;
}

void close_obs() {
    webSocketShutdownCallback();
}
